# Julia wrapper for header: rtmidi_c.h
...
function rtmidi_api_name(api)
    ccall((:rtmidi_api_name, librtmidi), Cstring, (RtMidiApi,), api)
end

function rtmidi_api_display_name(api)
    ccall((:rtmidi_api_display_name, librtmidi), Cstring, (RtMidiApi,), api)
end

function rtmidi_compiled_api_by_name(name)
    ccall((:rtmidi_compiled_api_by_name, librtmidi), RtMidiApi, (Cstring,), name)
end
